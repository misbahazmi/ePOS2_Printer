...
public class PrinterSettingActivity extends Activity implements View.OnClickListener, MaintenanceCounterListener, PrinterSettingListener{
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnSetPrintSpeed:
                // Show waiting restart message. onSetPrinterSetting stop this message.
                mProgressIndicator.beginProgress(getString(R.string.restart_Setting_msg));
                if(!setPrintSpeed()){
                    mProgressIndicator.endProgress();
                }
                break;
    ...
    protected boolean setPrintSpeed() {
    ...
    protected boolean setPrintDensity() {
        HashMap<Integer, Integer> settingList = new HashMap<Integer, Integer>();
    ...
    protected boolean setPaperWidth() {
        HashMap<Integer, Integer> settingList = new HashMap<Integer, Integer>();
